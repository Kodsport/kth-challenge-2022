\problemname{Emergency Exit}

\illustration{0.42}{emergencyexit.png}{}
...
Otherwise, print one line with the integer $S$, the number of seconds it takes to get everyone out.
